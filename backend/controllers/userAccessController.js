...
exports.getMyAccess = async (req, res) => {
  ...
  res.json({
    ...
    user_database: authScope === "directory" ? INVENTORY_DB_NAME : userDatabase,
    user_ref: `${authScope === "directory" ? INVENTORY_DB_NAME : userDatabase}:${userId}`,
    auth_scope: authScope || "database_local",
